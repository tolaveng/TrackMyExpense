...
namespace Core.Infrastructure.Database
{
    ...
    public class AppDbContext : IdentityDbContext<AppIdentityUser, AppIdentityRole, Guid>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Expense>().HasOne(x => x.Category).WithMany().HasForeignKey(x => x.CategoryId).OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity<RecurrentExpense>().HasOne(x => x.Category).WithMany().HasForeignKey(x => x.CategoryId).OnDelete(DeleteBehavior.NoAction);
            
            modelBuilder.Entity<Category>().HasOne(x => x.Icon).WithMany().OnDelete(DeleteBehavior.NoAction);
